...
class ThreeFire extends THREE.Mesh {
	constructor( fireTex, color ) {
		...
		super(new THREE.BoxGeometry( 1.0, 1.0, 1.0 ), fireMaterial); //THREE.Mesh.call( this, geometry, material);
...
export class Flame extends Com {
	...
	static async Create(wob, babs, scale, yup) {
		...
		com.fire.material.uniforms.noiseScale.value = new THREE.Vector4(
